      ...
      <div className="fixed inset-0 z-50 bg-bg-elevated flex flex-col sm:inset-auto sm:top-0 sm:right-0 sm:h-full sm:w-[380px] sm:border-l sm:border-border">
        ...
        <div className="flex items-center justify-between h-11 px-3 border-b border-border shrink-0">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button onClick={onClose} aria-label="Close" className="p-1 rounded-md hover:bg-bg-hover text-text-muted hover:text-text-secondary transition-colors">
              <CloseIcon size={14} />
            </button>
          </div>
        </div>
          ...
          <div className="shrink-0 border-t border-border p-3 space-y-2">
            <div className="flex items-center gap-2">
              <button
                onClick={handleFetch}
                disabled={fetching}
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-[11px] font-medium bg-bg-surface border border-border text-text-muted hover:text-text-secondary hover:bg-bg-hover transition-colors disabled:opacity-40 disabled:pointer-events-none"
              >
            ...
            {hasChanges && (
              <>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-[12px] font-medium bg-bg-surface border border-border text-text-secondary hover:text-text hover:bg-bg-hover transition-colors disabled:opacity-40 disabled:pointer-events-none"
                >
